...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(messages: json["messages"] == null ? null : List<RideMessage>.from(json["messages"]!.map((x) => RideMessage.fromJson(x))), imagePath: json["image_path"]);
