...
class SupportMessage {
  ...
  SupportMessage({this.id, this.supportTicketId, this.adminId, this.message, this.createdAt, this.updatedAt, this.ticket, this.admin, this.attachments, this.isLoading = false});
