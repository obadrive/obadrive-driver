...
class CustomSnackBar {
  static void error({required List<String> errorList, int duration = 5, SnackPosition position = SnackPosition.TOP}) {
  ...
  static void success({required List<String> successList, int duration = 2, SnackPosition position = SnackPosition.TOP}) {
