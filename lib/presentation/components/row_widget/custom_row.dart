        ...
        : isAbout
            ...
            : Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [Flexible(child: Text(firstText.tr, style: regularDefault.copyWith(color: MyColor.colorBlack), overflow: TextOverflow.ellipsis, maxLines: 1)), isStatus ? StatusWidget(status: lastText, color: MyColor.greenP) : Flexible(child: Text(lastText.tr, maxLines: 2, style: regularDefault.copyWith(color: isStatus ? MyColor.greenSuccessColor : MyColor.bodyText), overflow: TextOverflow.ellipsis, textAlign: TextAlign.end))],
                  ),
                  const SizedBox(height: 5),
                  showDivider ? const CustomDivider(space: 10) : const SizedBox(),
