...
class ChatBubbleClipper6 extends CustomClipper<Path> {
  ...
  ChatBubbleClipper6({this.type, this.radius = 10, this.nipSize = 8, this.sizeRatio = 2});
  ...
  Path getClip(Size size) {
    ...
    if (type == BubbleType.sendBubble) {
      ...
      path.quadraticBezierTo(size.width, size.height, size.width - nipSize, size.height - nipSize / sizeRatio);
      ...
      path.quadraticBezierTo(0, size.height, nipSize / sizeRatio, size.height - nipSize);
