                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(subtitle ?? "", style: subtitleStyle ?? regularDefault.copyWith(fontSize: Dimensions.fontSmall, color: MyColor.bodyText.withValues(alpha: 0.8)), maxLines: 1, overflow: TextOverflow.ellipsis),
                        const SizedBox(height: Dimensions.space5),
                        Container(
