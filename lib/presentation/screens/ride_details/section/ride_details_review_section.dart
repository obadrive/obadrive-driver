      ...
      return AnnotatedRegionWidget(
        child: Column(
          ...
          children: [
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      StringConverter.formatNumber(controller.ride.user?.avgRating ?? '0.0'),
                ...
                GestureDetector(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text("+${controller.ride.user?.mobile}", style: boldDefault.copyWith(color: MyColor.colorGrey, fontSize: Dimensions.fontDefault, fontWeight: FontWeight.w700)),
                    ],
                  ),
                ),
              ],
            ...
            Text(MyStrings.ratingRider.tr, style: semiBoldDefault.copyWith(fontSize: Dimensions.fontOverLarge + 2)),
            const SizedBox(height: Dimensions.space20),
            RatingBar.builder(
