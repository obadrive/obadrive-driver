                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              MyImageWidget(imageUrl: '${controller.driverImagePath}/${review.driver?.avatar}', height: 50, width: 50, radius: 25, isProfile: true),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Expanded(child: Text('${review.driver?.firstname ?? ''} ${review.driver?.lastname ?? ''}'.toCapitalized(), style: boldDefault.copyWith(color: MyColor.primaryColor))),
